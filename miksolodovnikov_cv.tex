...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Large{Mikhail Solodovnikov}} & \textbf{March 2021}\\
...
\section{Experience}
  \resumeSubHeadingListStart
   ...
   \resumeSubheading
      ...
      {Senior Software Development Engineer, Identity}{June. 2022 -- Currently}
      \resumeItemListStart
        \resumeItem{Software Engineering}
                   {Design and develop data pipelines, build telemetry aggregations for partner team business units analytics. Apply best practice and improve processes.}
   ...
   \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Software Engineering}
                   {Design and develop highly scalable distributed software systems. Implement software delivery best practice and improve processes.}
        \resumeItem{Operations}
