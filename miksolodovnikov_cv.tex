...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Large{Mikhail Solodovnikov}} & \textbf{September 5, 2016}\\
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Consulting in IT}
          {Web-services development (services wtih Django/Django REST, Angular JS, mobile apps with Ionic).}
    \resumeItemListEnd
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: Python, Groovy, Java, Javascript, SQL}
      %\hfill
      \\
      \textbf{Technologies}{: Linux, AWS, REST, Grails, RDBMS, git}
    }
  \resumeSubHeadingListEnd
