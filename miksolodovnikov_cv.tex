...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Large{Mikhail Solodovnikov}} & \textbf{March 2020}\\
...
\section{Experience}
  \resumeSubHeadingListStart
   ...
   \resumeSubheading
      {\href{https://amazon.com}{Amazon}}{Dublin}
      {Software Development Engineer, SES}{June. 2019 -- Recently}
      \resumeItemListStart
        \resumeItem{Software Engineering}
                   {Design and develop highly scalable distributed software systems. Work on implementing continues deployment pipelines.}
