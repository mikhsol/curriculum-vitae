...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Large{Mikhail Solodovnikov}} & \textbf{July 2017}\\
...
%   GitHub \\
   GitHub: \href{https://github.com/mikhsol}{mikhol}\\
 \end{tabular*}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {\href{http://votetour.com}{LLC Svoi Tour}}{}
      {CTO}{Mar. 2017 -- present}
      \resumeItemListStart
        ...
        \resumeItem{Business Development}
          {Working with partners (airlines) to provide best services for customers.}
    ...
    \resumeSubheading
      ...
      {Full Stack Software Developer}{May 2015 -- Sep. 2016}
      \resumeItemListStart
        ...
        \resumeItem{Consulting}
          {Develop solutions for company customers, using Nebulytics platform.}
        \resumeItem{DevOps}
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: Python, Java, Groovy, Javascript, SQL}
      %\hfill
      \\
      \textbf{Technologies}{: Linux, CI, TDD, Agile, Django/Django REST, ReactJS, AWS, REST, Grails, RDBMS, Git}
    }
  \resumeSubHeadingListEnd
