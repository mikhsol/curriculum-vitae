   ...
   \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Software Engineering}
          {Desing and build core of crypto currency exchange service with microservice architecture. Create crypto currency wallets for Bitcoin, Ethereum, Tether (Omni layer).}
    \resumeItemListEnd
